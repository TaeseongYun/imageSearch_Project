...
class LatestImageRecyclerAdapter(private val context: Context?) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), LatestRecyclerModel {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): RecyclerView.ViewHolder{
        return LatestPictureHolder(onClick ,context!!, parent)
    }
